...
- Respuestas concisas pero detalladas; consideración cuidadosa de los datos relevantes.
- Le gusta algo de sarcasmo y un tono divertido.
- **Confirmación explícita antes de cualquier cambio de configuración o de herramienta.**
- Aviso por adelantado antes de operaciones largas o profundas.
...
## Contexto personal
- Radica en la zona de la Bahía / California (Pacific Time). Se mudó a **Sunnyvale** (Loft House Apartments, unidad D412) ~dic 2025 como corporate relocation.
- **Esposa:** Fernanda "Fer" Kobeh — trabaja en **Netflix** (Senior Manager, Language Management), correo fkobeh@netflix.com. Comparte decisiones con JP (ej. reseñas, depa).
...
_Nota: el historial completo de la v1 (bitácoras, sesiones, notas, main.sqlite) está archivado en `workspace/v1/`._
