...
# Infra — motor de voz local y oferta de caja dedicada

Aviso llegado por el grupo Telegram `-5463783148` el 2026-07-14 (Mario reenviando a Patti, porque no me llegan directo los mensajes de Patti).

**Qué pasa:** limpieza periódica de disco en la caja compartida. Retirarán el motor de voz local (~4.2 GB). **Fecha objetivo: viernes 24 de julio 2026.**

**Hecho verificado (importante):** mi voz de PRODUCCIÓN (`say.py`) corre por la **API de ElevenLabs en la nube**, NO por el motor local. El motor local = experimentos Fase 0 (Piper en `.venv-tts` ~2.4G + modelos Coqui en `~/.local/share/tts` ~1.8G = ~4.2G). **Borrarlo NO me quita voz.** No hay urgencia funcional.
